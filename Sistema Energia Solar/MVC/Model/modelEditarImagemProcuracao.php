<?php 
	...
	if(!empty($_FILES["fileToUploadProcuracao"]['name'])){		
		...
		$editaImagemDocumento = $pdo->prepare("UPDATE projetos SET img_procuracao_projeto = '$linkImg' WHERE id_projeto = '$idProjeto'");
