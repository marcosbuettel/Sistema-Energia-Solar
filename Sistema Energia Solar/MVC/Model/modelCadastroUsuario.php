<?php 
	...
	$cadastrarUsuario = $pdo->prepare("INSERT INTO usuarios (nome_usuario, imagem_usuario, senha_usuario, telefone_usuario, email_usuario, cpf_cnpj_usuario, cidade_usuario, estado_usuario, tipo_usuario) VALUES ('$nomeUsuario', '$linkImg','$senhaUsuario','$telefoneUsuario', '$emailUsuario', '$cpfCnpjUsuario', '$cidadeUsuario', '$estadoUsuario', 'leitor')");
