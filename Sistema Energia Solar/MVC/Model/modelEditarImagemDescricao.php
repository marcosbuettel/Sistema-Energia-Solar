<?php 
	...
	if(!empty($_FILES["fileToUploadDescricao"]['name'])){		
		...
		$editaImagemDocumento = $pdo->prepare("UPDATE projetos SET img_descricao_projeto = '$linkImg' WHERE id_projeto = '$idProjeto'");
