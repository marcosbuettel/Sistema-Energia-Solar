...
<?php if($_SESSION['id-usuario-logado'] == $verificaId){?>
	...
	<section class="projetos-wrapper separador ">
		...
		<div class="lista-projetos-wrapper">
			<div class="lista-projetos" style="display: block" id="lista-projetos<?php echo $totalUsuarioEscolhido[$i]['id_usuario']?>">
				<table>
					<tr>
						<th>Nome:</th>
						<th>Data:</th>
					...
					<?php 
						...
						$verificaProjetos = $pdo->prepare("SELECT * FROM projetos WHERE id_usuario = '$idUsuarioLogado' AND nome_projeto LIKE '%$projetoBuscado%'");
