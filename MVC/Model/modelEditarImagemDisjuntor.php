<?php 
	...
	if(!empty($_FILES["fileToUploadDisjuntor"]['name'])){		
		...
		$editaImagemDocumento = $pdo->prepare("UPDATE projetos SET img_disjuntor_projeto = '$linkImg' WHERE id_projeto = '$idProjeto'");
