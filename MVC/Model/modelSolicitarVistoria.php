<?php 
	...
	$aprovarDocumentosProjeto = $pdo->prepare("UPDATE projetos SET status_projeto = 'vistoria-solicitada' WHERE id_projeto = '$idProjeto'");
	$aprovarDocumentosProjeto->execute();


	$tipoNotificacao = "vistoria-solicitada";
